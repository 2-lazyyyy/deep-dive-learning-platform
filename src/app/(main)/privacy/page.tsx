  ...
  return (
    <div className="pb-20 max-w-3xl mx-auto px-6">
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-3xl font-extrabold text-[#000313] dark:text-white">Privacy Policy</h1>
      </div>
      <div className="space-y-6 mt-4">
        <p className="text-sm font-bold text-[#6B7280] dark:text-gray-400">Last Updated: August 2026</p>
        
        <div className="space-y-4">
          <h2 className="text-xl font-extrabold text-[#000313] dark:text-white">1. Information We Collect</h2>
          ...
          <h2 className="text-xl font-extrabold text-[#000313] dark:text-white pt-4">2. How We Use Information</h2>
          <p className="text-[#000313] dark:text-white font-bold leading-relaxed">
          ...
          <h2 className="text-xl font-extrabold text-[#000313] dark:text-white pt-4">3. Data Security</h2>
          <p className="text-[#000313] dark:text-white font-bold leading-relaxed">
