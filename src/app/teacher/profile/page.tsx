...
export default function TeacherProfilePage() {
  ...
  return (
    <div className="pb-20 max-w-2xl mx-auto">
      ...
      <div className="flex items-center gap-6 mb-8 border-b-2 border-[#00031333] dark:border-white/20 pb-8">
      ...
      <div className="mb-10">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="p-4 rounded-2xl border-2 border-[#00031333] dark:border-white/20 flex items-center gap-4 bg-white dark:bg-[#000313]">
            ...
            <div>
              <p className="font-extrabold text-xl text-[#000313] dark:text-white">24</p>
              <p className="text-sm font-bold text-[#000313] dark:text-white">Challenges Made</p>
            </div>
          </div>
          <div className="p-4 rounded-2xl border-2 border-[#00031333] dark:border-white/20 flex items-center gap-4 bg-white dark:bg-[#000313]">
            <BookOpen size={32} className="text-[#0ba2b3]" />
            <div>
              <p className="font-extrabold text-xl text-[#000313] dark:text-white">10</p>
              <p className="text-sm font-bold text-[#000313] dark:text-white">Active Lessons</p>
            </div>
          </div>
          <div className="p-4 rounded-2xl border-2 border-[#00031333] dark:border-white/20 flex items-center gap-4 bg-white dark:bg-[#000313]">
            <CheckCircle size={32} className="text-[#0ba2b3]" />
            <div>
              <p className="font-extrabold text-xl text-[#000313] dark:text-white">1,248</p>
              <p className="text-sm font-bold text-[#000313] dark:text-white">Submissions</p>
            </div>
          </div>
          <div className="p-4 rounded-2xl border-2 border-[#00031333] dark:border-white/20 flex items-center gap-4 bg-white dark:bg-[#000313]">
            <TrendingUp size={32} className="text-[#0ba2b3]" />
            <div>
              <p className="font-extrabold text-xl text-[#000313] dark:text-white">78%</p>
              <p className="text-sm font-bold text-[#000313] dark:text-white">Pass Rate</p>
            </div>
          </div>
        </div>
      </div>
